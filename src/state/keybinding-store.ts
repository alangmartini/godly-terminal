...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  },
  {
    ...
    category: 'Split',
    type: 'app',
    defaultChord: { ctrlKey: true, shiftKey: false, altKey: false, key: 'arrowleft' },
  },
  {
    id: 'split.focusRight',
    ...
    category: 'Split',
    type: 'app',
    defaultChord: { ctrlKey: true, shiftKey: false, altKey: false, key: 'arrowright' },
  },
  {
    id: 'split.focusUp',
    label: 'Focus Pane Up',
    category: 'Split',
    type: 'app',
    defaultChord: { ctrlKey: true, shiftKey: false, altKey: false, key: 'arrowup' },
  },
  {
    id: 'split.focusDown',
    ...
    category: 'Split',
    type: 'app',
    defaultChord: { ctrlKey: true, shiftKey: false, altKey: false, key: 'arrowdown' },
  },
  {
    id: 'split.resizeLeft',
