...
pub fn compare_screens(
    ...
    is!(
        Bytes(&got.contents_diff(godly_vt::Parser::default().screen())),
        Bytes(&expected.contents_diff(godly_vt::Parser::default().screen()))
    );
...
pub fn contents_formatted_reproduces_screen(screen: &godly_vt::Screen) -> bool {
    ...
    let mut new_parser = godly_vt::Parser::default();
...
pub fn rows_formatted_reproduces_screen(screen: &godly_vt::Screen) -> bool {
...
pub fn contents_diff_reproduces_state_from_screens(
    prev_screen: &godly_vt::Screen,
    screen: &godly_vt::Screen,
) -> bool {
