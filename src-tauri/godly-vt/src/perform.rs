...
impl<CB: crate::callbacks::Callbacks> crate::state_machine::Perform for WrappedScreen<CB> {
    ...
    fn csi_dispatch(
        &mut self,
        params: &crate::state_machine::Params,
        intermediates: &[u8],
        _ignore: bool,
        c: char,
    ) {
...
fn canonicalize_params_1(params: &crate::state_machine::Params, default: u16) -> u16 {
