...
// parameter that boosts mid-range coverage values.  Browsers render text with
...
impl AtlasPrimitive {
    ...
    pub fn draw(&self, pipeline: &AtlasPipeline, render_pass: &mut wgpu::RenderPass<'_>) -> bool {
