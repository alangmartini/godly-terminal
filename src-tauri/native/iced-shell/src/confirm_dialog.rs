...
mod tests {
    ...
    fn desktop_notify_prompt_renders_unchecked() {
        let _el: Element<'_, TestMsg> =
            view_desktop_notify_prompt(false, TestMsg::Confirm, TestMsg::Cancel, TestMsg::Toggle);
    }

    #[test]
    fn desktop_notify_prompt_renders_checked() {
        let _el: Element<'_, TestMsg> =
            view_desktop_notify_prompt(true, TestMsg::Confirm, TestMsg::Cancel, TestMsg::Toggle);
    }
}
